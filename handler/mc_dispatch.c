...
//to map user message to handler 
  BEGIN_MESSAGE_MAP_ONLINE
     ...
     MESSAGE_HANDLER(MSG_USR_SWITCHLAB)
     MESSAGE_HANDLER(MSG_USR_SETCONFIG)
     MESSAGE_HANDLER(MSG_USR_CALIBRATION_START)
     MESSAGE_HANDLER(MSG_DSA_CALIBRATION_RANGING)
     MESSAGE_HANDLER(MSG_DSR_CALIBRATION_RESULT)
